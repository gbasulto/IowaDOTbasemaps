...
| Function | Purpose |
|----|----|
| [`addIowaBasemap()`](https://gbasulto.github.io/IowaDOTbasemaps/reference/addIowaBasemap.md) | Add greyscale, dark greyscale or color DOT vector basemap |
| [`addCartoBasemap()`](https://gbasulto.github.io/IowaDOTbasemaps/reference/addCartoBasemap.md) | Add authenticated CARTO Positron, Dark Matter or Voyager |
| [`removeBasemap()`](https://gbasulto.github.io/IowaDOTbasemaps/reference/removeBasemap.md) | Remove a IowaDOTbasemaps basemap by `layerId` |
| [`clearBasemaps()`](https://gbasulto.github.io/IowaDOTbasemaps/reference/clearBasemaps.md) | Remove IowaDOTbasemaps basemaps while retaining incident overlays |
| [`dotBasemaps()`](https://gbasulto.github.io/IowaDOTbasemaps/reference/dotBasemaps.md) | List configured DOT maps and snapshot dates |
| [`checkDOTBasemaps()`](https://gbasulto.github.io/IowaDOTbasemaps/reference/checkDOTBasemaps.md) | Compare current Web Map/child metadata with your catalog |
| [`refreshDOTBasemaps()`](https://gbasulto.github.io/IowaDOTbasemaps/reference/refreshDOTBasemaps.md) | Save a refreshed catalog or adopt replacement IDs |
| [`runBasemapExample()`](https://gbasulto.github.io/IowaDOTbasemaps/reference/runBasemapExample.md) | Run the bundled Shiny regression example |
...
does not remove IowaDOTbasemaps basemaps, even in CARTO raster mode.
[`clearBasemaps()`](https://gbasulto.github.io/IowaDOTbasemaps/reference/clearBasemaps.md)
does not remove an older
[`addTiles()`](https://rstudio.github.io/leaflet/reference/map-layers.html)/[`addProviderTiles()`](https://rstudio.github.io/leaflet/reference/addProviderTiles.html)
background; remove that old basemap call when adopting IowaDOTbasemaps.
